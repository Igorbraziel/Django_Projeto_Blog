...
class Page(models.Model):
    ...
    is_published = models.BooleanField(default=False, help_text='This field must be checked to display this page publicly')
...
class Post(models.Model):
    ...
    is_published = models.BooleanField(default=False, help_text='This field must be checked to display this post')
    content = models.TextField()
    cover = models.ImageField(upload_to='posts/%Y/%m/', blank=True, default=None)
    cover_in_post_content = models.BooleanField(default=True, help_text='This field must be checked to display the cover of the post')
